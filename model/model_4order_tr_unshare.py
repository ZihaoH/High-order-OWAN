...
class OperationLayer(nn.Module):
    ...
    def forward(self, x, weights):
        ...
        out2 = torch.einsum('achw,rck->arhwk', (states, self.w_cp2))
        out3 = torch.einsum('achw,rck->arhwk', (states, self.w_cp3))
        out4 = torch.einsum('achw,rck->arhwk', (states, self.w_cp4))
        out = torch.einsum('arhwk,akhwq,aqhws,ashwp,pom->arohwm', (out1,out2,out3,out4, self.w_out3))
