#!/usr/bin/env python
# -*- coding: utf-8 -*-
# 2 order, CP decomposition, unshare parameter, using tensor1x1_conv.py
...
import utils
import time
from tensor1x1_conv import Tensor1x1Conv
import pynvml
pynvml.nvmlInit()
## Operation layer
class OperationLayer(nn.Module):
    def __init__(self, C, stride, rank):
        ...
        self.tensor1x1conv = Tensor1x1Conv(C_in=C*self.op_num , C_out=C, rank=rank, order=2, share_core = True, add1=False, TN_format = 'CP')
    ...
    def forward(self, x, weights):
        ...
        return self.tensor1x1conv(states)
...
if __name__=='__main__':
    ...
    model = Network(16, 10, L1_loss,steps=4,rank=4).cuda()
